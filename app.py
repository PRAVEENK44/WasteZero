...
if inventory_df is not None:
    ...
    st.sidebar.markdown("---")
    st.sidebar.info("Engine Version: v2.1.0-Core")
    st.sidebar.markdown("<small>Proprietary Optimization Architecture</small>", unsafe_allow_html=True)
